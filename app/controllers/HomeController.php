...
class HomeController extends BaseController {
	...
	*/
	...
	public function index() {
		...
		$courses = Course::all();
		return View::make('home.home')->with('courses', $courses);
	}
	...
	public function showLession($courseid) {
		$lessions = Course::find($courseid)->Lessions;
		$coursename = Course::find($courseid)->title;
